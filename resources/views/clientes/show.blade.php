            ...
            <div class="bg-white rounded-lg overflow-hidden">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="bg-gray-50">
                            <td colspan="2" class="px-4 py-2 font-semibold text-primary">
                                Dados Básicos
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="px-4 py-2 font-medium">Celular</td>
                            <td class="px-4 py-2 mask-celular">{{ $cliente->celular }}</td>
                        </tr>

                        <tr>
                            <td class="px-4 py-2 font-medium">Telefone</td>
                            <td class="px-4 py-2 mask-telefone">{{ $cliente->telefone }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 mask-cep">{{ $cliente->cep }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2">{{ $cliente->observacoes }}</td>
                        </tr>
